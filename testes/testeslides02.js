...
slideshowContainer1.style.animation = 'slideAnimation 2s infinite';
...
function showSlides1() {
  ...
  setTimeout(showSlides1, 2000); // Altera o slide a cada 5 segundos (5000 milissegundos)
}
...
function showSlides2() {
  ...
  setTimeout(showSlides2, 2000); // Altera o slide a cada 5 segundos (5000 milissegundos)
}
...
function showSlides3() {
  ...
  setTimeout(showSlides3, 2000); // Altera o slide a cada 5 segundos (5000 milissegundos)
}
